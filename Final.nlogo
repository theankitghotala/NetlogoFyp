...
to consume-and-collect
  ...
  set psugar max list (psugar - sugar-metabolism) 0  ;; Ensure psugar never goes negative

  ;; Consume spice similarly
  set spice max list (spice - spice-metabolism + max list pspice spice-metabolism) 0
  set pspice max list (pspice - spice-metabolism) 0  ;; Ensure pspice never goes negative
end
...
to-report perceived-threat
  ;let nearby-enemies turtles with [color = red] in-radius 3  ;; Example: red turtles are enemies
